...
{
    /// <inheritdoc />
    public partial class DB_Configurations_V0 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastOnline = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValueSql: "GETUTCDATE()"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Servers_AspNetUsers_AdminId",
                        column: x => x.AdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxUsers = table.Column<int>(type: "int", nullable: false, defaultValue: 50),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BotRooms", x => new { x.BotId, x.RoomId });
                    table.ForeignKey(
                        name: "FK_BotRooms_Bots_BotId",
                        column: x => x.BotId,
                        principalTable: "Bots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BotRooms_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BotRooms_RoomId",
                table: "BotRooms",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_Bots_ServerId",
                table: "Bots",
                column: "ServerId");
